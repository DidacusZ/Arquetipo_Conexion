 ...
 */
	private String[] configurarConexion() {
		...
		try {
			...
			datosConexion.load(new FileInputStream(new File("C:${symbol_escape}${symbol_escape}Users${symbol_escape}${symbol_escape}clase${symbol_escape}${symbol_escape}git${symbol_escape}${symbol_escape}Conexion_BD_Java${symbol_escape}${symbol_escape}src${symbol_escape}${symbol_escape}util${symbol_escape}${symbol_escape}conexion.properties")));
